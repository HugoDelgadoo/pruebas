...
public class ClientThread extends Thread {
    ...
    //Initialise socket as null
    long tiempoEjecucion;

	
    public ClientThread(String nombre)
    {
            super(nombre);             
    }
        ...
        try 
        {
            ...
            while (true) {            
                ...
                if (eJuego.esAcertado()){
                    ...
                    this.tiempoEjecucion = fin-ini;
                    System.out.println(this.getName()+ " tu tiempo de ejecucuión ha sido "+ this.tiempoEjecucion);
